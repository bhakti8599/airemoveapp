...
import 'package:airemoveapp/ui/topup/topup.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class PricingPlanPageUI extends StatefulWidget {
  @override
  _PricingPlanUIState createState() => _PricingPlanUIState();
}

class _PricingPlanUIState extends State<PricingPlanPageUI> {
  @override
                    ...
                    Container(
                      ...
                      child: TextButton(
                          style: ButtonStyle(
                            ...
                            backgroundColor:
                                MaterialStateProperty.all(Color(0XFFA5C6F8)),
                          ),
                          onPressed: () {
                            Navigator.push(
                                context,
                          ...
                          style: ButtonStyle(
                            shape: MaterialStateProperty.all<
                                ...
                                RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(0))),
                            backgroundColor:
                                MaterialStateProperty.all(Color(0XFF1B1B1B)),
                          ),
                          onPressed: () {
                            Navigator.push(
                                context,
                  ...
                  TextButton(
                      style: ButtonStyle(
                        side: MaterialStateProperty.all<BorderSide>(
                            BorderSide(color: Color(0XFFA5C6F8), width: 2)),
                        shape:
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Free Forever. For Personal use only',
                    ...
                    Row(
                      children: [
                        Text(
                          'Limited monthly credits via API',
                          style:
                              Theme.of(context).textTheme.bodyText1!.copyWith(
                                    color: Colors.white,
                                  ),
